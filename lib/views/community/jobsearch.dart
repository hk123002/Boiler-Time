...
class JobSearch extends StatefulWidget {
  ...
  @override
  State<JobSearch> createState() => _communityState();
}

//final _post = FirebaseFirestore.instance.collection('post');
final CollectionReference _jobsearch =
    FirebaseFirestore.instance.collection('jobsearch');

class _communityState extends State<JobSearch> {
// text fields' controllers
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    await _jobsearch.add({"Title": title, "Content": content});
  ...
  Future<void> _delete(String jobsearchID) async {
    await _jobsearch.doc(jobsearchID).delete();
