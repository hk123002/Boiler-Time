...
class Intern extends StatefulWidget {
  ...
  @override
  State<Intern> createState() => _communityState();
}

//final _post = FirebaseFirestore.instance.collection('post');
final CollectionReference _intern =
    FirebaseFirestore.instance.collection('intern');

class _communityState extends State<Intern> {
// text fields' controllers
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    await _intern.add({"Title": title, "Content": content});
  ...
  Future<void> _delete(String internID) async {
    await _intern.doc(internID).delete();
